        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav">
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="/users" class="menu-link menu-toggle">
                                    ...
                                    <span class="menu-label">
                                        <span class="label label-rounded label-primary">{{  $count_data }}</span>
                                    </span>
                                ...
                                <a href="/admin/service" class="menu-link menu-toggle">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                ...
                                <a href="/admin/regulations" class="menu-link menu-toggle">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                ...
                <li class="menu-item" aria-haspopup="true">
                    <a href="/admin/app_settings" class="menu-link">
